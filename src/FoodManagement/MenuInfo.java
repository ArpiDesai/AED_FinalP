...
public class MenuInfo extends javax.swing.JPanel {
     ...
     */
    system s;
    public MenuInfo(system s) {
        initComponents();
        this.s = s;
        populateHotelusername();
        populateHotelname();
        populateTable();
    }
    ...
    private void initComponents() {
        ...
        itemtype.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Starters", "Main Course", "Dessert", "Beverages" }));
    ...
    private void createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createActionPerformed
        ...
        {
            flag=0;
            JOptionPane.showMessageDialog(this,"Hotel Username cannot be empty");
            return;
        }
        ...
        if(flag == 1)
        {
            ...
            Menu pp = s.getMenudirectory().addNewMenu();
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        s.getMenudirectory().deleteMenu(selectedep);
...
//        pharmacyname.setSelectedItem("Select");
    ...
    private void viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewActionPerformed
        ...
        pharmacyusername.setSelectedItem(String.valueOf(selectedep.getHotelusername()));
        pharmacyname.setSelectedItem(String.valueOf(selectedep.getHotelname()));
...
private void populateHotelname(){
     String[] cc = s.getHoteldirectory().HotelnameArray();
     DefaultComboBoxModel c = new DefaultComboBoxModel(cc);
     pharmacyname.setModel(c);
}

private void populateHotelusername(){
     String[] cc = s.getHoteldirectory().HotelusernameArray();
     DefaultComboBoxModel c = new DefaultComboBoxModel(cc);
